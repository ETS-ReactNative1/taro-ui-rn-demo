...
let IconGoogleplusSquareF = ({ size, color, ...rest }) => {
  return (
...
IconGoogleplusSquareF.defaultProps = {
  size: 18,
};

IconGoogleplusSquareF = React.memo ? React.memo(IconGoogleplusSquareF) : IconGoogleplusSquareF;

export default IconGoogleplusSquareF;
