...
IconCodepenCircleFill.defaultProps = {
  size: 18,
};

IconCodepenCircleFill = React.memo ? React.memo(IconCodepenCircleFill) : IconCodepenCircleFill;

export default IconCodepenCircleFill;
