Component({
  ...
  data: {
    colors: '',
    svgSize: 36 / 750 * swan.getSystemInfoSync().windowWidth,
    quot: '"',
    isStr: true,
  },
  methods: {
