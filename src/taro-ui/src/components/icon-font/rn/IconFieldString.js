...
let IconFieldString = ({ size, color, ...rest }) => {
  return (
...
IconFieldString.defaultProps = {
  size: 18,
};

IconFieldString = React.memo ? React.memo(IconFieldString) : IconFieldString;

export default IconFieldString;
