...
let IconDeleteteam = ({ size, color, ...rest }) => {
  return (
...
IconDeleteteam.defaultProps = {
  size: 18,
};

IconDeleteteam = React.memo ? React.memo(IconDeleteteam) : IconDeleteteam;

export default IconDeleteteam;
