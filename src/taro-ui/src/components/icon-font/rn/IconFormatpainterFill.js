...
let IconFormatpainterFill = ({ size, color, ...rest }) => {
  return (
...
IconFormatpainterFill.defaultProps = {
  size: 36,
};

IconFormatpainterFill = React.memo ? React.memo(IconFormatpainterFill) : IconFormatpainterFill;

export default IconFormatpainterFill;
