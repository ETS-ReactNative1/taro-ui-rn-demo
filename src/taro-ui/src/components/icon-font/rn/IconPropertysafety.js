...
let IconPropertysafety = ({ size, color, ...rest }) => {
  return (
...
IconPropertysafety.defaultProps = {
  size: 36,
};

IconPropertysafety = React.memo ? React.memo(IconPropertysafety) : IconPropertysafety;

export default IconPropertysafety;
