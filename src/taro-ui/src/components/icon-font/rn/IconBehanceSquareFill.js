...
let IconBehanceSquareFill = ({ size, color, ...rest }) => {
  return (
...
IconBehanceSquareFill.defaultProps = {
  size: 36,
};

IconBehanceSquareFill = React.memo ? React.memo(IconBehanceSquareFill) : IconBehanceSquareFill;

export default IconBehanceSquareFill;
