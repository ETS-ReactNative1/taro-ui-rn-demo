...
let IconQqSquareFill = ({ size, color, ...rest }) => {
  return (
...
IconQqSquareFill.defaultProps = {
  size: 18,
};

IconQqSquareFill = React.memo ? React.memo(IconQqSquareFill) : IconQqSquareFill;

export default IconQqSquareFill;
