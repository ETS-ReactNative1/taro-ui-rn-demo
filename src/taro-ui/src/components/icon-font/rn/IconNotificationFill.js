...
let IconNotificationFill = ({ size, color, ...rest }) => {
  return (
...
IconNotificationFill.defaultProps = {
  size: 36,
};

IconNotificationFill = React.memo ? React.memo(IconNotificationFill) : IconNotificationFill;
