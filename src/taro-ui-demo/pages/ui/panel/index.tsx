...
export default class PanelBasic extends React.Component<{}, PanelBasicState> {
  ...
  private gotoComponent(id: string, parent: string): void {
    Taro.navigateTo({
      url: `/pages/ui/${parent.toLowerCase()}/${id.toLowerCase()}/index`
    })
  }
      ...
      <View className='page'>
        ...
        <View className='panel-header'>
          <View className='panel-header__icon'>
            {icon ? (
              <Image src={icon} className='panel-header__icon__img' mode='widthFix' />
            ) : (
        ...
        <View className='panel-body'>
          <View className='component-list'>
            {itemList.map(item => (
              ...
              >
                <Text className='component-list__item__name'>{`${item.id} ${item.name}`}</Text>
                <Image className='component-list__item__icon' src={require('../../../assets/images/right.png')} />
              </View>
            ))}
          </View>
        </View>
